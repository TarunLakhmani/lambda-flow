// === File: src/lambdas/orchestrator/triggerApiGateway.js ===
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const triggerNode = nodes.find((n) => n.type === 'apigatewaytrigger');
    if (!triggerNode) throw new Error('Trigger node not found in workflow');
